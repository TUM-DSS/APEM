...
# Define network and file paths
NETWORK_NAME = "pypsa_eur_small"
NETWORK_FILE = "elec_s_40_ec_lv1.5_.nc"
BASE_PATH = f"src/data/raw_data/{NETWORK_NAME}/"
...
n.generators.insert(3, "min_prod", n.generators["p_min_pu"] * n.generators["p_nom"]) # calculate minimum production
...
n.lines = n.lines.groupby(['bus0', 'bus1'], as_index=False).agg({'F_max': 'sum', 'B': 'mean'}) # aggregate parallel lines
