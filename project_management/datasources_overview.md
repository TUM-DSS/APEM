...
- Generation: 
    - Input files: 
        - minimum/maximum power, ramp rates, min time on/off, start-up costs, type (e.g. Hard Coal Old 1) for thermal units (from PEMMDB) <br />
        <img src="bzr_data_screenshots/input_files_thermal.png" alt="Input Files - Thermal" width="800" height="auto"> <br />
        - aggregate hourly RES production for Germany (from PECD) <br />
        <img src="bzr_data_screenshots/input_files_wind.png" alt="Input Files - RES" width="700" height="auto"> <br />
    - Grid model: 
        - broad category of type (e.g. Thermal) <br />
        <img src="bzr_data_screenshots/grid_model_generation.png" alt="Grid Model - Generation" width="500" height="auto"> <br />
...
- Load: 
    - Input files: aggregate hourly load for Germany <br />
    <img src="bzr_data_screenshots/input_files_load.png" alt="Input Files - Load" width="500" height="auto"> <br />
    - Grid model: base load (p) <br />
    <img src="bzr_data_screenshots/grid_model_load.png" alt="Grid Model - Load" width="200" height="auto">  <br />
    - we distributed the hourly demand from the input files proportional to the base load
    
- Grid: comprehensive representation of the grid; we used topological nodes, excluded breakers and disconnectors, added some missing data from JAO static grid, and assigned coordinates to substations based on OpenStreetMap <br />
<img src="bzr_data_screenshots/grid_model_uml.png" alt="Grid Model - UML" width="1200" height="auto"> <br /> 
