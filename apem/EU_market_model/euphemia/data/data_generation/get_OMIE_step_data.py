...
def main() -> None:
    ...
    date_ini = dt.datetime(2025, 3, 25)
    date_end = dt.datetime(2025, 3, 25)
    ...
    for hour in range(1, 25):
        ...
        df = OMIESupplyDemandCurvesImporter(date_ini=date_ini, date_end=date_end, hour=hour).read_to_dataframe(
            verbose=True
        )
