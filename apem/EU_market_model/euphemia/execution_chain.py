...
def solve_euphemia(dataset: EU_Datasets, cutting_strategy: CutType):
    """
...
def run_evaluation():
    ...
    datasets = [EU_Datasets.GENERATED_SMALL, EU_Datasets.GENERATED_LARGE, EU_Datasets.GME, EU_Datasets.OMIE, EU_Datasets.ARPA]
